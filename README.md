...
Some leaf-traits may be extracted from full stack predictions and/or post-processed full stack predictions. Trait extraction is currently in development stage--see [relevant jupyter notebook](https://github.com/mattjenkins/3DLeafCT/blob/add_changes/ML_microCT/jupyter/LeafTraits.ipynb).
